...
@section('main_content')
    ...
    {{-- modal Add Data --}}
    <div class="modal fade" id="form-modal"  permission="dialog" aria-labelledby="modal-form-label" aria-hidden="true">
        <div class="modal-dialog" permission="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-input">
                        <input type="hidden" name="kategori_obat_id" id="permission-id">
                        <div class="form-group">
                            <label>{{ __('Nama Permission') }} <span class="text-danger">*</span></label>
    ...
    {{-- modal Detail --}}
    <div class="modal fade" id="detail-modal"  permission="dialog" aria-labelledby="modal-detail-label" aria-hidden="true">
        <div class="modal-dialog" permission="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <p id="detail-permission" class="form-control"></p>
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#form-modal').on('hidden.bs.modal', function() {
                $('#permission-id').val('')
                $('#modal-form-label').text('Add Permission')
                $('#nama-kategori').val('')
            ...
            $(document).on('click', '.edit-btn', function() {
                let id = $(this).data('id')
                let url = '{{ route('permission-detail', ':id') }}'
                url = url.replace(':id', id)
                $('#permission-id').val(id)
                $('#modal-form-label').text('Edit {{ __('Permission') }}')
            ...
            $(document).on('click', '.detail-btn', function() {
                ...
                $.get(url, function(response) {
                    let data = response.data
                    $('#detail-permission').html(data.name)
            ...
            $('#save-btn').on('click', function() {
                ...
                let url = '{{ route('permission-create') }}'
                let kategori_obat_id = $('#permission-id').val()
