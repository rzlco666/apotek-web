                    ...
                    <div class="card-body">
                        <div class="d-sm-flex d-block justify-content-between">
                            <div class="flex-grow-1">
                                ...
                                </div><span class="font-primary f-w-700">Padang</span>
                                <p>Sumatra Barat</p>
                            </div>
                        </div>
                        <div class="greeting-user">
                            ...
                            <h4><a href="user-profile.html"> {{ Auth::user()->name }} </a><span class="right-circle"><i
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex"><img class="img-fluid align-top circle"
                                            ...
                                            <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span>Ossim keter</span></a>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex"><img class="img-fluid align-top circle"
                                            ...
                                            <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span>Venter loren</span></a>
                                                <p class="mb-0">Now</p>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex"><img class="img-fluid align-top circle"
                                            ...
                                            <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span>Fran loain</span></a>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex"><img class="img-fluid align-top circle"
                                            ...
                                            <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span>Loften Horen</span></a>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex"><img class="img-fluid align-top circle"
                                            ...
                                            <div class="flex-grow-1"><a href="{{ route('user-profile') }}"><span>Loie fenter</span></a>
                                                <p class="mb-0">2 Day After</p>
                                            </div>
                                            <div class="active-status active-offline"></div>
                                        </div>
