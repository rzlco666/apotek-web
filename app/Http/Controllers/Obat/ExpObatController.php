...
class ExpObatController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('obat.exp_obat.index', $data);
    }
    ...
    {
        $data = ExpObat::with('data_obat')->get();
    ...
    public function store(Request $request)
    {
        ...
        $ref_kategori = ExpObat::create($params);
    ...
    {
        $data = ExpObat::where('id', $id)->with('data_obat', 'data_obat.category_obat')->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        $ref_kategori = ExpObat::where('id', $id)->first();
        ...
        $ref_kategori->tanggal_kadaluwarsa = $request->tanggal_kadaluwarsa;
